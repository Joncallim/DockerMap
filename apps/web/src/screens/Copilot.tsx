...
export default function Copilot() {
  const { model, loading, error, evidenceMode, modelProvenance, observedHistory } = useApp();
  ...
  const result = useMemo<CopilotAnswer | null>(() => {
    ...
    return answer(model, submitted, evidenceMode, modelProvenance, observedHistory);
  }, [model, submitted, evidenceMode, modelProvenance, observedHistory]);

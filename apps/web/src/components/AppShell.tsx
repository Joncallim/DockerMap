...
import type { AuthWhoamiResponse, FindingsResponse, ObservedChangeHistoryResponse, ObservedDockerEventHistoryResponse, ObservedResourceTelemetryResponse } from "@dockermap/contracts";

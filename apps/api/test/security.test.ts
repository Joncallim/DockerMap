...
test("daemon model responses require non-empty revision and complete provider state bytes", async () => {
  ...
  const invalidResponses = [
    ...
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[3].evidenceRefs[1].kind = "docker_volume_mount"; return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[3].evidenceRefs[0].providerRevision = String(value.findings[3].evidenceRefs[0].collectedAt); return value; })()],
    ...
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[5].evidenceRefs[1].providerRevision = "mismatched-revision"; return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[5].evidenceRefs[1].freshness = "stale"; return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[5].targetRef = "host_risk_untrusted"; return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[5].id = "finding_docker_daemon_state_bind_mount_publishes_port_forged"; return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[5].evidenceRefs[1].summary = "DOCKERMAP_TEST_FORGED_PORT"; return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[5].unsafe = "DOCKERMAP_TEST_EXTRA"; return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[6].summary = "DOCKERMAP_TEST_FORGED_COMPOSE_FINDING"; return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[6].id = "finding_docker_compose_declared_target_not_active_forged"; return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[6].evidenceRefs[0].freshness = "stale"; return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[6].evidenceRefs[0].kind = "docker_network_membership"; return value; })()],
    ...
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[6].unsafe = "DOCKERMAP_TEST_EXTRA"; return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[7].id = "finding_docker_compose_mutual_dependency_forged"; return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[7].summary = "DOCKERMAP_TEST_FORGED_MUTUAL_COMPOSE_FINDING"; return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); [value.findings[7].subjectRef, value.findings[7].targetRef] = [value.findings[7].targetRef, value.findings[7].subjectRef]; return value; })()],
    ...
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[7].evidenceRefs[1].collectedAt += 1; return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[7].evidenceRefs[1].providerRevision = "other-revision"; return value; })()],
    ...
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[7].evidenceRefs[1].kind = "docker_network_membership"; return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[7].evidenceRefs[0].freshness = "stale"; return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); [value.findings[8].evidenceRefs[0], value.findings[8].evidenceRefs[1]] = [value.findings[8].evidenceRefs[1], value.findings[8].evidenceRefs[0]]; return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[8].targetRef = "compose_runtime_binding_" + "0".repeat(64); return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[8].evidenceRefs[0].id = "/private/path/compose.yaml"; return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[8].evidenceRefs[1].providerRevision = "other-observation"; return value; })()],
    ...
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[8].evidenceRefs[0].summary = "/private/path/compose.yaml"; return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[9].targetRef = "host_risk_untrusted"; return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[9].summary = "DOCKERMAP_TEST_FORGED_UNSPECIFIED_ADDRESS"; return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[9].evidenceRefs[0].kind = "docker_port_publication"; return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[9].evidenceRefs[0].summary = "0.0.0.0:443"; return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[9].evidenceRefs[0].providerSlot = "project_npm"; return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[9].evidenceRefs[0].freshness = "stale"; return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[9].evidenceRefs.push(structuredClone(value.findings[9].evidenceRefs[0])); return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[10].targetRef = "runtime_integrity_risk_other"; return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[10].evidenceRefs[0].summary = "collision: secret-provider-value"; return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[10].evidenceRefs[0].freshness = "stale"; return value; })()],
    ["/daemon/findings", (() => { const value = structuredClone(findings); value.findings[10].evidenceRefs[0].providerRevision = "fixture-revision"; return value; })()],

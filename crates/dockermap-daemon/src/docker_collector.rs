...
use crate::{
    ...
    docker_events::DOCKER_EVENT_ACTIONS,
...
impl DockerCollector {
    ...
    /// Open the one allowed Docker event stream shape through the filtered
    /// gateway. `since` is generated by the daemon's bounded replay cursor;
    /// no route, caller input, or provider slot can alter these filters.
